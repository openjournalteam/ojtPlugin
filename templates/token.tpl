        ...
        <div  class="w-full mx-auto">
            <form class="flex flex-col gap-4" x-ref="form">
                <div class="text-lg font-bold">
                    ...
                    Enter the token you bought at <a href="https://openjournaltheme.com" class="text-blue-500">openjournaltheme.com</a></small>
                </div>
                <div class="font-medium bg-green-100 rounded-lg py-5 px-6 mb-4 text-base text-green-700 mb-3" role="alert" x-show="quota_added">
                ...
                <div class="form-group">
                    <label for="editor_name">Token <span class="text-red-700">*</span></label>
                    <input autocomplete="off" x-model="formData.token" class="w-full"
                        placeholder="Enter token" type="text" required>
                </div>
                <div class="mt-2 flex gap-2 items-center">
                    <button type="submit" @click.prevent="submit()"
                        ...
                        :class="{ 'hover:cursor-progress': activationButton.loading }" :disabled="activationButton.loading"
