  ...
  <template x-if="plugins && !loading && !error">
    <div>
      <div class="ojt-relative ojt-py-4">
        <label for="default-search" class="ojt-mb-2 ojt-text-sm ojt-font-medium ojt-text-gray-900 ojt-sr-only dark:ojt-text-gray-300">Search</label>
        <div class="relative">
            <div class="ojt-flex ojt-absolute ojt-inset-y-0 ojt-left-0 ojt-items-center ojt-pl-3 ojt-pointer-events-none">
                <svg aria-hidden="true" class="ojt-w-5 ojt-h-5 ojt-text-gray-500 dark:ojt-text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
            </div>
            <input type="search" x-model="search" id="default-search" class="ojt-block ojt-p-3 ojt-pl-10 ojt-w-full ojt-text-sm ojt-text-gray-900 ojt-bg-gray-50 ojt-rounded-lg ojt-border ojt-border-gray-300 focus:ojt-ring-blue-500 focus:ojt-border-blue-500 dark:ojt-bg-gray-700 dark:ojt-border-gray-600 dark:ojt-placeholder-gray-400 dark:ojt-text-white dark:ojt-focus:ring-blue-500 dark:focus:ojt-border-blue-500" placeholder="Search Plugins ...">
        </div>
      </div>
      <section class="ojt-flex ojt-flex-row ojt-flex-wrap ojt-mx-auto ojt-grid sm:ojt-grid-cols-2 md:ojt-grid-cols-1 lg:ojt-grid-cols-3 ojt-gap-4">
        <!-- Card Component -->
  ...
  <template x-if="error">
    <div class="empty ojt-flex ojt-flex-col">
      <div class="empty-icon ojt-my-2 ojt-text-gray-600 ojt-mx-auto">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ojt-w-10 ojt-h-10">
