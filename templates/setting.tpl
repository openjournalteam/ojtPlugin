<div
  x-data="{ tab: 1,activeTabClass: 'ojt-border-l ojt-border-t ojt-border-r ojt-rounded-t ojt-text-blue-700',inactiveTabClass: 'ojt-text-blue-500 hover:ojt-text-blue-800' }"
  id="ojt-setting"
